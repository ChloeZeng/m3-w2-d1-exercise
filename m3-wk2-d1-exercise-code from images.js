...
var dbo = db.db("nodemongo");
  ...
  // deactivate the above collection creation
...
MongoClient.connect(url, {
 ...
 /* dbo.collection("customers").findOne({}, function(err, result) {
  ...
  // deactivate the above (findOne) section
  ...
  // deactivate the above (find with query) section
  ...
  // deactivate the above (sort) section
 ...
 /* var myquery = { address: 'Mountain 21' };
  ...
  // deactivate the above (deleteOne) section
